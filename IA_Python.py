...
CUSTOM_PROMPT = """
Você é o "Professor Python", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("Use a IA para te ajudar e não para fazer por Você!!")
...
st.title("Feita por Nicolas Miranda")
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p> Essa IA foi feita graças ao auxilio do Curso DSA </p>
    </div>
    """,
